%
% Plot a rainbow colour bar
% cd /Users/henshaw/DropBox/CG/rbins/twoFallingBodies
...
%     hcb=colorbar; 
    % set(hcb,'YTick',[t1(1),t1(1+is),t1(1+2*is),t1(1+3*is),t1(1+4*is),t1(1+5*is),t1(1+6*is),t1(1+7*is)])
    % set(hcb,'YTick',[1.5,2.5,3.5,4.5,5.5,6.5,7.5,8.5]);
